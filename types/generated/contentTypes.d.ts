...
export interface ApiKwClusterKwCluster extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '';
    displayName: 'KW_Cluster';
    pluralName: 'kw-clusters';
    singularName: 'kw-cluster';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiKwDevelopmentKwDevelopment
  extends Struct.CollectionTypeSchema {
  collectionName: 'kw_developments';
  info: {
    description: '';
    displayName: 'KW_Development';
    pluralName: 'kw-developments';
    singularName: 'kw-development';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiKwNewsEventKwNewsEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::kw-news-event.kw-news-event'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiKwTheCityKwTheCity extends Struct.SingleTypeSchema {
  ...
  info: {
    description: '';
    displayName: 'KW_The_City';
    pluralName: 'kw-the-cities';
    singularName: 'kw-the-city';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    development: Schema.Attribute.DynamicZone<[]>;
    image: Schema.Attribute.Media<'images'>;
    label: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::kw-the-city.kw-the-city'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
